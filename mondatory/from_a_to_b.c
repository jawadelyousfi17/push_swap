...
/*   Updated: 2025/01/15 20:12:03 by jel-yous         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	from_a_to_b(t_stack *stack_a, t_stack *stack_b)
{
	...
	{
		cheapest_index = get_cheapest_index(stack_a, stack_b);
		target_index = get_terget_index(stack_b, stack_a->arr[cheapest_index]);
